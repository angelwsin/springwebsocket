...
<script type="text/javascript">
	...
	if ('WebSocket' in window) {
		websocket = new WebSocket("ws://localhost/springWS/myHandler");
	} 
	else if ('MozWebSocket' in window) {
		websocket = new MozWebSocket("ws://localhost/springWS/myHandler");
	} 
	else {
		websocket = new SockJS("http://localhost/springWS/sockjs/myHandler");
	}
