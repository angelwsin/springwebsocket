...
<script type="text/javascript">
	...
	if ('WebSocket' in window) {
		websocket = new WebSocket("ws://localhost/springwebSocket/webSocketServer.do");
	} 
	else if ('MozWebSocket' in window) {
		websocket = new MozWebSocket("ws://localhost/springwebSocket/webSocketServer.do");
	} 
	else {
		websocket = new SockJS("http://localhost/springwebSocket/sockjs/webSocketServer.do");
	}
